...
$sql = "select * from Carpool_Room where Status='Open'";
...
<th><b><span style='text-align: center'><font class='c' color='black' size='4'>Price expected</font></span></b></th>
<th><b><span style='text-align: center'><font class='c' color='black' size='4'>Vehicle Kind</font></span></b></th>
</thead>";
echo "<tbody>";
echo "<tbody>";
while($row = mysqli_fetch_array($res)){
    ...
    echo "<tr><td>" .$row['RoomId']. "</td><td>" .$row['Departure']. "</td><td>" .$row['Arrival']. "</td><td>" .$month. "/" .$day. " - " .$hour. ":" .$minute. "</td><td>" .$row['GN']. "</td><td>" .$row['Price']. "</td><td>" .$row['Kind']. "</td></tr>";
}
echo "</tbody></table>";

echo "<a href='car_join_select.html'><input type='button' value='Select Room'></a>";
