...
echo "<form method='post'><action='taxi_chat_save.php'>";
...
$sql = "insert into Taxi_Chat (context, speaker, Taxi_Room_RoomId) values ('{$context}','{$name}','{$id}')";
mysqli_query($conn,$sql);

echo "<span style='text - align: left'><font class='c' color='white' size='5'> Chat </font></span><br><br>";
echo "<div>";
$sql = "select context, speaker from Taxi_Chat where Taxi_Room_RoomId='$id'";
$res = mysqli_query($conn, $sql);
